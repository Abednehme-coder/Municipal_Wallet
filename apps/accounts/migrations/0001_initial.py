    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Administrator'), ('MAYOR', 'Mayor'), ('TREASURER', 'Treasurer'), ('COUNCIL_MEMBER', 'Council Member'), ('AUDITOR', 'Auditor'), ('VIEWER', 'Viewer')], default='VIEWER', max_length=20)),
